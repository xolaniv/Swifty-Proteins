...
class ProtienViewController: UIViewController {
    var Protein: String?
    var scnView: SCNView!
    ...
    override func viewDidLoad() {
        ...
        let shareButton = UIBarButtonItem(barButtonSystemItem: .save, target: self, action: #selector(Shared))
        self.navigationItem.rightBarButtonItem = shareButton
        
        let tapGR = UITapGestureRecognizer(target: self, action: #selector(ProtienViewController.didTap(_:)))
